 ...
 * CLI version: 2.14.2
 *
 * Generated: Mon, 27 Oct 2025 08:21:05 GMT
 */
...
var APP_com_domain_app_demov2 = (function () {
  ...
  var Img = (imageUrl, options) => {
    const imageServerUrl = Settings$1.get('platform', 'imageServerUrl');
    ...
    const setOptions = options => {
      ...
      const imageQuality = Math.max(0.1, Math.min(1, (parseFloat(Settings$1.get('platform', 'image.quality')) || 100) / 100));
  ...
  // atoms/NavItem.ts
  // NavItem.ts
  class NavItem extends Lightning$1.Component {
    constructor() {
      super(...arguments);
    ...
    _init() {
      ...
      if (this._pendingIndicatorColor !== null) {
        ...
        ind === null || ind === void 0 ? void 0 : ind.patch({
          color: this._pendingIndicatorColor
        });
        this._pendingIndicatorColor = null;
      } else {
  ...
  class Header extends Lightning$1.Component {
    ...
    _applyCurrentByIndex(i) {
      this._currentIdx = i;
      const items = this.tag('Nav').children;
      items.forEach((c, idx) => c.routeActive = idx === i);
    }
  }

  class Tile extends Lightning$1.Component {
    constructor() {
      super(...arguments);
      this._title = '';
    }
    ...
    set title(v) {
      var _a;
      this._title = v;
      (_a = this.titleElement) === null || _a === void 0 ? void 0 : _a.patch({
        text: {
          text: v
        }
      });
  ...
  class Carousell extends Lightning$1.Component {
    static _template() {
      return {
        x: 40,
        w: 1920 - 80,
  ...
  class HomeSection extends Lightning$1.Component {
    ...
    _active() {
      var _a;
      (_a = this.tag('Viewport.Content.ContentInner.Header')) === null || _a === void 0 ? void 0 : _a.setCurrentByRoute('home');
    }
    _setup() {
      var _a, _b, _c;
      const inner = 'Viewport.Content.ContentInner';
      (_a = this.tag("".concat(inner, ".TopSearches"))) === null || _a === void 0 ? void 0 : _a.patch({
        title: 'Top searches',
        items: dummy$1(10)
      });
      (_b = this.tag("".concat(inner, ".NextWatch"))) === null || _b === void 0 ? void 0 : _b.patch({
        title: 'Your next watch',
        items: dummy$1(10)
      });
      (_c = this.tag("".concat(inner, ".Retro"))) === null || _c === void 0 ? void 0 : _c.patch({
        title: 'Retro TV',
        items: dummy$1(10)
      });
    ...
    _getFocused() {
      ...
      return this.tag("Viewport.Content.ContentInner.".concat(name));
    }
    _nameFor(idx) {
      // 0..3 → Carussel, TopSearches, NextWatch, Retro
      const arr = ['Carussel', 'TopSearches', 'NextWatch', 'Retro'];
  ...
  class Player extends Lightning$1.Component {
    ...
    static _template() {
      return {
        ...
        Hint: {
          ...
          y: 32,
          text: {
            text: 'Player · ←/→ seek · Enter play/pause · Back',
            fontSize: 22
          }
        }
      };
    ...
    _handleBack() {
      var _a, _b;
      (_b = (_a = this.application) === null || _a === void 0 ? void 0 : _a.$router) === null || _b === void 0 ? void 0 : _b.back();
    }
    _handleLeft() {
    ...
    _toggle() {
      ...
      if (this._paused) VideoPlayer.pause();else (_a = VideoPlayer.play()(this.tag('Controls.PlayPause'))) === null || _a === void 0 ? void 0 : _a.patch({
  ...
  class SuggestSection extends Lightning$1.Component {
    ...
    _nameFor(idx) {
      // 0..3 → Carussel, TopSearches, NextWatch, Retro
      const arr = ['TopSearches', 'NextWatch', 'Retro'];
      const i = Math.max(0, Math.min(idx, arr.length - 1));
      return arr[i];
    }
    // ↓ pasa a la siguiente sección
